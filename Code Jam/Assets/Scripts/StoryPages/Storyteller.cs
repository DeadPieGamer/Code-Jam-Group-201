...
public class Storyteller : MonoBehaviour
{
    ...
    private float prettyInstantly = 0.001f;
    ...
    private void SkipWait()
    {
        ...
        if (currentClipLength <= prettyInstantly) currentClipLength = prettyInstantly;
    ...
    private IEnumerator PlayQueuedClips(float waitLength)
    {
        ...
        if (narrationQueue.Count > 0)
        {
            StartCoroutine(PlayQueuedClips(currentClip != null ? currentClip.length : prettyInstantly));
        }
    }
